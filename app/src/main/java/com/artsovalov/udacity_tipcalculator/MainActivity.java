package com.artsovalov.udacity_tipcalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setTipValues() {
        tvTipPercent.setText(getString(R.string.mai_msg_tippercent, percentage));
        tvTipAmount.setText(getString(R.string.mai_msg_tiptotal, tipTotal));
        tvBillTotalAmount.setText(getString(R.string.mai_msg_billtotalresult, finalBillAmount));
    }

    @OnClick({R.id.ibRegularServices, R.id.ibGoodServices, R.id.ibExcellentServices})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.ibRegularServices:
                percentage = REGULAR_TIP_PERCENTAGE;
                break;
            case R.id.ibGoodServices:
                percentage = DEFAULT_TIP_PERCENTAGE;
                break;
            case R.id.ibExcellentServices:
